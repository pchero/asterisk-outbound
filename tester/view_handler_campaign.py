# -*- coding: utf-8 -*-
"""
Created on Sat Dec 31 18:15:31 2016
...
class FrameMain(object):
    ...
    def frame_setup(self):
        self.frame_campaign_main()
        self.update_list_items("campaign")
        return
    

    def frame_campaign_main(self):
    ...
    def _action_button_show(self):
        ...
        # get search uuid
        ret = tkSimpleDialog.askstring("Show campaign", "Please enter a campaign uuid")
        if ret == None:
            return
        ...
        if ret == "":
            ...
            data = {"Uuid":ret}
            self.action_handler.send_cmd_async("OutCampaignShow", data)
        return
    ...
    def _action_button_create(self):
        ...
        self.action_handler.send_cmd_async("OutCampaignCreate")
        return
    ...
    def _action_button_update(self):
        ...
        self.action_handler.send_cmd_async("OutCampaignUpdate", items)
        return
    ...
    def _action_button_delete(self):
        ...
        data = {"Uuid":uuid}
        self.action_handler.send_cmd_async("OutCampaignDelete", data)
        return
    ...
    def update_list_items(self, table):
        ...
        if table == None or table != "campaign":
            return
        
        self.list_items = self.data_handler.campaign_get_list_all()
    ...
    def update_detail_items(self, uuid):
        ...
        data = self.data_handler.campaign_get(uuid)
        if data == None:
            print("Could not find correct campaign info. uuid[%s]" % uuid)
            return
